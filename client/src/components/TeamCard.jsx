...
const TeamCard = ({ name, role, photo, description }) => {
  return (
    <div className="bg-gray-900/50 border border-gray-700/50 rounded-xl p-6 h-full shadow-lg backdrop-blur-sm hover:bg-gray-800/60 hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-500/20 hover:-translate-y-2 transition-all duration-500 ease-out flex flex-col items-center text-center">
      {/* Photo */}
