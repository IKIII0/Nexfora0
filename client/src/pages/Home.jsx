      ...
      <div className="relative container mx-auto px-6 mb-10">
        <div className="flex justify-center items-center gap-5">
          <button 
            ...
            className="bg-white/10 border-2 text-blue-400 font-bold py-2 px-8 hover:border-purple-500 hover:text-purple-500 rounded-full text-lg transition-all duration-300 hover:scale-110 hover:shadow-2xl animate-on-load animate-scale-in delay-100 relative overflow-hidden group"
          >
            Kelas
          </button>
          <button 
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-300 mb-4">
                  Instruktur berpengalaman dengan sertifikasi internasional dalam bidang programming dan teknologi terkini.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-gray-700/50 rounded-lg p-4">
                    ...
                    />
                    <p className="text-sm text-gray-300">Sertifikat Web Development</p>
                  </div>
                  <div className="bg-gray-700/50 rounded-lg p-4">
                    <img 
                      ...
                      className="w-full h-24 object-cover rounded mb-2"
                    />
                    <p className="text-sm text-gray-300">Sertifikat Mobile Development</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="relative top-full left-1/2 transform -translate-x-1/2 mt-4 bg-gray-800/95 backdrop-blur-sm border border-gray-700 rounded-2xl p-6 w-full max-w-4xl shadow-2xl z-50 animate-fade-in">
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-300 mb-4">
                  Developer profesional dengan pengalaman 5+ tahun dalam pembuatan website modern dan responsif.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-gray-700/50 rounded-lg p-4">
                    <img 
          ...
          <div className="relative top-full left-1/2 transform -translate-x-1/2 mt-4 bg-gray-800/95 backdrop-blur-sm border border-gray-700 rounded-2xl p-6 w-full max-w-4xl shadow-2xl z-50 animate-fade-in">
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-300 mb-4">
                  Desainer kreatif dengan spesialisasi dalam poster, branding, dan desain visual yang menarik.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-gray-700/50 rounded-lg p-4">
                    <img 
                  ...
                  <div className="bg-gray-700/50 rounded-lg p-4">
                    <img 
                      ...
                      className="w-full h-24 object-cover rounded mb-2"
                    />
                    <p className="text-sm text-gray-300">Brand Identity Design</p>
                  </div>
                </div>
              </div>
            </div>
